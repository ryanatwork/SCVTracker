...
describe "crime_tips/new.html.haml" do
  before(:each) do
    assign(:crime_tip, stub_model(CrimeTip,
      :crime_id => 1,
  ...
  it "renders new crime_tip form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => crime_tips_path, :method => "post" do
      assert_select "input#crime_tip_crime_id", :name => "crime_tip[crime_id]"
      ...
      assert_select "input#crime_tip_suspect_race_id", :name => "crime_tip[suspect_race_id]"
      assert_select "input#crime_tip_suspect_gender", :name => "crime_tip[suspect_gender]"
      ...
      assert_select "input#crime_tip_suspect_school_id", :name => "crime_tip[suspect_school_id]"
      ...
      assert_select "input#crime_tip_drug_id", :name => "crime_tip[drug_id]"
      assert_select "input#crime_tip_team_id", :name => "crime_tip[team_id]"
