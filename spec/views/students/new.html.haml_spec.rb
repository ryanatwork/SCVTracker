...
describe "students/new.html.haml" do
  ...
  it "renders new student form" do
    ...
    assert_select "form", :action => students_path, :method => "post" do
      ...
      assert_select "input#student_race_id", :name => "student[race_id]"
      ...
      assert_select "input#student_updated_school_id", :name => "student[updated_school_id]"
      ...
      assert_select "input#student_drug_id", :name => "student[drug_id]"
